...
public class DiseñoTraductorView extends javax.swing.JFrame {
    ...
    private void jTextAreaSALIDAAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jTextAreaSALIDAAncestorAdded
        ...
        //jTextAreaSALIDA.setEnabled(false);
        //jTextAreaSALIDA.setEnabled(true);
    ...
    private void ButtonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonActualizarActionPerformed
        ...
        ButtonTraducir.setEnabled(true);        // TODO add your handling code here:
    ...
    private void ButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonEliminarActionPerformed
        // ELIMINANDO PALABRAS
        //new Eliminar(jTextAreaENTRADA.getText()).setVisible(true);

        // this.hide();
        //jTextAreaENTRADA.getText();
